...
//   useEffect(() => {
//     axios
//         .get(`/emp/getDetailsforPMOApprovalByOnboardingStatus${onboardingStatus}`)
//         .then((res) => {
//             setData(res.data.data);
//             console.log(res.data);
//         });
        ...
        <div>
            <Box sx={{ width: '100%', typography: 'body1' }}>
                <Row  style={{paddingBottom:"10px"}}>
                    <Col md="2">
                        <Card style={{padding:"15px",textAlign:"center"}}><h5>Pre Hire</h5><h5>{data.length}</h5></Card>
                    </Col>
                    <Col md="2">
                        <Card style={{padding:"15px",textAlign:"center"}}><h5>Onboardings For Today</h5></Card>
                    </Col>
                    <Col md="2">
