...
function TAAHeadRejected(props) {
  ...
  const RejectHandler = (e) => {
    ...
    const obj = { onboardingStatus: "Pending",userType:user };
    const form1 = Object.assign(form, obj);
    axios.put(`/emp/updateRejectStatus/${onboardingId}/${user}`, form1)
      .then((res) => {
        console.log(res)
        if (res.status == 200) {
          props.func();
...
export default TAAHeadRejected
