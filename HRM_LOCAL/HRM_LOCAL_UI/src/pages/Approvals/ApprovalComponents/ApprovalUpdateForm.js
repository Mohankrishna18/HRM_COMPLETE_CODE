...
//     const [phoneNumber, setPhonenNumber] = useState(props.updateOnboard.phoneNumber)
//     const [dateOfJoining, setDateOfJoining] = useState(props.updateOnboard.dateOfJoining)
...
//     const [designation, setDesignation] = useState(props.updateOnboard.designation)
//     const [employmentType, setEmployementType] = useState(props.updateOnboard.employmentType)
//     const [primarySkills, setPrimarySkills] = useState(props.updateOnboard.primarySkills)
//     const [secondarySkills, setSecondrySkills] = useState(props.updateOnboard.secondarySkills)
...
//         e.preventDefault();
//         axios.put(`/emp/updatedOnbordingDataById${props.updateOnboard.onboardingId}`, {firstName,middleName,lastName,email,phoneNumber,dateOfJoining,yearsOfExperience, designation,department,employmentType,primarySkills,secondarySkills,jobTitle})
//                 .then((response) => {
