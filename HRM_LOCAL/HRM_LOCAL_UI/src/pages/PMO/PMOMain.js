      ...
      <Card className="scroll" style={{ backgroundColor: "white" }}>
       ...
       // textColor="secondary"
        indicatorColor="#f5896e">
                      <Tab label="Leave/WFH Approvals" style={{paddingRight:"2%",paddingLeft:"2%",fontSize:"16px"}} value="1" />
                      ...
                      <Tab label="Hiring" style={{paddingRight:"2%",paddingLeft:"2%",fontSize:"16px"}} value="4" />
                      <Tab label="Requisition Approvals" style={{paddingRight:"2%",paddingLeft:"2%",fontSize:"16px"}} value="5" />
                    </TabList>
                  </Box>
