...
package com.arshaa.urp.controller;import java.util.List;
...
import com.arshaa.urp.service.UserService;@RequestMapping("/user")
@RestController
...
public ResponseEntity updateModuleBymoduleID(@PathVariable int moduleId,@RequestBody Modulemaster newModulemaster) { return serv.updateModuleBymoduleID(moduleId, newModulemaster);
}
@DeleteMapping("/DeleteModuleDataByModuleID/{moduleId}")
public ResponseEntity DeleteModuleDataByModuleID(@PathVariable int moduleId ) { return serv.DeleteModuleDataByModuleID(moduleId);
}
